...
export const canisterId = process.env.CANISTER_ID_TOKEN_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_canister.did.js")._SERVICE>}
 */
